...
This spreadsheet shows the raw dump of the parallels of the Bhikkhu and Bhikkhunī Pāṭimokkhas in all the Buddhist schools, using an API call to the SuttaCentral server for each rule.
